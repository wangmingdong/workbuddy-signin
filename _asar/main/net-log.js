...
const require_proxy_from_env$1 = require("./proxy-from-env.js");
let tls = require("tls");
...
var require_diagnostics = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	var util$4 = require("node:util");
	var undiciDebugLog = util$4.debuglog("undici");
	var fetchDebuglog = util$4.debuglog("fetch");
	var websocketDebuglog = util$4.debuglog("websocket");
...
var require_client = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	var net$3 = require("node:net");
	var http$5 = require("node:http");
	var util = require_util$7();
	var { channels } = require_diagnostics();
...
var require_util$4 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	var { btoa: btoa$1 } = require("node:buffer");
...
var require_receiver = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var { Writable: Writable$1 } = require("node:stream");
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/ms/index.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/debug/src/common.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/debug/src/browser.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/has-flag/index.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/supports-color/index.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/debug/src/node.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/debug/src/index.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/agent-base/dist/helpers.js
var require_helpers = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var http$4 = __importStar(require("http"));
	var https$3 = __importStar(require("https"));
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/agent-base/dist/index.js
var require_dist$2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var http$3 = __importStar(require("http"));
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/http-proxy-agent/dist/index.js
var require_dist$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var tls$2 = __importStar(require("tls"));
	...
	var HttpProxyAgent = class extends agent_base_1.Agent {
		...
		async connect(req, opts) {
			...
			if (this.proxy.protocol === "https:") {
				...
				socket = tls$2.connect(this.connectOpts);
			} else {
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/https-proxy-agent/dist/parse-proxy-response.js
...
//#endregion
//#region ../../packages/workbuddy-server/node_modules/https-proxy-agent/dist/index.js
...
async function resolveProxyForUrl(targetUrl) {
	...
	if (currentResolver) try {
		...
		pacLog.info(`[PacAware] resolve url=${sanitizeUrlForLog$1(targetUrl)} rule="${resolved.rawRule}" → ${resolved.proxyUrl ? `proxy=${sanitizeProxyForLog(resolved.proxyUrl)}` : "DIRECT"}`);
	} catch (err) {
...
function sanitizeUrlForLog$1(targetUrl) {
	try {
		const u = new URL(targetUrl);
...
function buildAxiosAgentsForProxy(proxyUrl, protocol, tlsOpts) {
	...
	if (!bundle) {
		const { HttpProxyAgent } = require_dist$1();
...
//#endregion
//#region ../../node_modules/axios/node_modules/form-data/lib/populate.js
...
//#endregion
//#region ../../node_modules/axios/node_modules/form-data/lib/form_data.js
var require_form_data = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	var CombinedStream = require_proxy_from_env$1.require_combined_stream();
	...
	var mime = require_proxy_from_env$1.require_mime_types();
	var asynckit = require_proxy_from_env$1.require_asynckit();
	var setToStringTag = require_proxy_from_env$1.require_es_set_tostringtag();
	var hasOwn = require_common$1.require_hasown();
...
var require_debug = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	module.exports = function() {
		if (!debug) {
			try {
				debug = require_common$1.require_src()("follow-redirects");
			} catch (error) {}
...
//#endregion
//#region ../../node_modules/axios/node_modules/follow-redirects/index.js
...
var require_axios = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	var url = require("url");
	var proxyFromEnv = require_proxy_from_env$1.require_proxy_from_env();
...
function resolveTrustedCAs() {
	...
	if (typeof getCACertificates === "function") {
		if (disableSystemCA) systemSkipped = true;
		else try {
	...
	proxyAgentLog.info(`[NetProxy] resolveTrustedCAs: bundled=${bundledCount} system=${systemCount}${systemSkipped ? "(skipped)" : ""} extra=${extraCount} merged=${cas.size} getCACertAvailable=${typeof getCACertificates === "function"} disableSystemCA=${disableSystemCA}`);
...
function installUndiciProxyDispatcher() {
	...
	const mergedNoProxy = mergeNoProxy(process.env.NO_PROXY || process.env.no_proxy);
...
function logNetRequest(entry) {
	try {
		...
		const url = sanitizeUrlForLog(entry.url);

...
const require_json_schema_traverse$1 = require("./json-schema-traverse.js");
const require_types$1 = require("./types.js");
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/helpers/util.js
var util;
(function(util) {
	util.assertEqual = (_) => {};
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/ZodError.js
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/locales/en.js
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/errors.js
var overrideErrorMap = errorMap;
function getErrorMap() {
	return overrideErrorMap;
}
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/helpers/parseUtil.js
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/helpers/errorUtil.js
var errorUtil;
(function(errorUtil) {
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/types.js
...
ZodPipeline.create;
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4/mini/schemas.js
var ZodMiniType = /* @__PURE__ */ require_types$1.$constructor("ZodMiniType", (inst, def) => {
	if (!inst._zod) throw new Error("Uninitialized schema in ZodMiniType.");
	require_types$1.$ZodType.init(inst, def);
	inst.def = def;
	inst.type = def.type;
	inst.parse = (data, params) => require_types$1.parse(inst, data, params, { callee: inst.parse });
	inst.safeParse = (data, params) => require_types$1.safeParse(inst, data, params);
	inst.parseAsync = async (data, params) => require_types$1.parseAsync(inst, data, params, { callee: inst.parseAsync });
	inst.safeParseAsync = async (data, params) => require_types$1.safeParseAsync(inst, data, params);
	inst.check = (...checks) => {
		return inst.clone({
			...def,
	...
	inst.clone = (_def, params) => require_types$1.clone(inst, _def, params);
	inst.brand = () => inst;
...
var ZodMiniObject = /* @__PURE__ */ require_types$1.$constructor("ZodMiniObject", (inst, def) => {
	require_types$1.$ZodObject.init(inst, def);
	ZodMiniType.init(inst, def);
	require_types$1.defineLazy(inst, "shape", () => def.shape);
});
/* @__NO_SIDE_EFFECTS__ */
function object(shape, params) {
	return new ZodMiniObject({
		type: "object",
		shape: shape ?? {},
		...require_types$1.normalizeParams(params)
	});
}
require_types$1.describe;
require_types$1.meta;
//#endregion
...
function safeParse(schema, data) {
	if (isZ4Schema(schema)) return require_types$1.safeParse(schema, data);
	return schema.safeParse(data);
}
async function safeParseAsync(schema, data) {
	if (isZ4Schema(schema)) return await require_types$1.safeParseAsync(schema, data);
...
function toJsonSchemaCompat(schema, opts) {
	if (isZ4Schema(schema)) return require_types$1.toJSONSchema(schema, {
...
var Protocol = class {
	constructor(_options) {
		...
		this.setNotificationHandler(require_types$1.CancelledNotificationSchema, (notification) => {
			this._oncancel(notification);
		});
		this.setNotificationHandler(require_types$1.ProgressNotificationSchema, (notification) => {
			this._onprogress(notification);
		});
		this.setRequestHandler(require_types$1.PingRequestSchema, (_request) => ({}));
		this._taskStore = _options?.taskStore;
		this._taskMessageQueue = _options?.taskMessageQueue;
		if (this._taskStore) {
			this.setRequestHandler(require_types$1.GetTaskRequestSchema, async (request, extra) => {
				const task = await this._taskStore.getTask(request.params.taskId, extra.sessionId);
				if (!task) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, "Failed to retrieve task: Task not found");
				return { ...task };
			});
			this.setRequestHandler(require_types$1.GetTaskPayloadRequestSchema, async (request, extra) => {
				const handleTaskResult = async () => {
							...
							if (queuedMessage.type === "response" || queuedMessage.type === "error") {
								...
								if (resolver) {
									...
									if (queuedMessage.type === "response") resolver(message);
										...
										resolver(new require_types$1.McpError(errorMessage.error.code, errorMessage.error.message, errorMessage.error.data));
									}
								} else {
					...
					if (!task) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Task not found: ${taskId}`);
					...
					if (isTerminal(task.status)) {
						...
						return {
							...
							_meta: {
								...result._meta,
								[require_types$1.RELATED_TASK_META_KEY]: { taskId }
							}
						};
					}
					return await handleTaskResult();
			...
			this.setRequestHandler(require_types$1.ListTasksRequestSchema, async (request, extra) => {
				try {
					...
					throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Failed to list tasks: ${error instanceof Error ? error.message : String(error)}`);
				}
			});
			this.setRequestHandler(require_types$1.CancelTaskRequestSchema, async (request, extra) => {
				try {
					const task = await this._taskStore.getTask(request.params.taskId, extra.sessionId);
					if (!task) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Task not found: ${request.params.taskId}`);
					if (isTerminal(task.status)) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Cannot cancel task in terminal status: ${task.status}`);
					await this._taskStore.updateTaskStatus(request.params.taskId, "cancelled", "Client cancelled task execution.", extra.sessionId);
					this._clearTaskQueue(request.params.taskId);
					const cancelledTask = await this._taskStore.getTask(request.params.taskId, extra.sessionId);
					if (!cancelledTask) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Task not found after cancellation: ${request.params.taskId}`);
					return {
						_meta: {},
						...cancelledTask
					};
				} catch (error) {
					if (error instanceof require_types$1.McpError) throw error;
					throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidRequest, `Failed to cancel task: ${error instanceof Error ? error.message : String(error)}`);
				}
			});
		}
	}
	...
	_resetTimeout(messageId) {
		...
		if (info.maxTotalTimeout && totalElapsed >= info.maxTotalTimeout) {
			...
			throw require_types$1.McpError.fromError(require_types$1.ErrorCode.RequestTimeout, "Maximum total timeout exceeded", {
	...
	*/
	async connect(transport) {
		...
		this._transport.onmessage = (message, extra) => {
			...
			if (require_types$1.isJSONRPCResultResponse(message) || require_types$1.isJSONRPCErrorResponse(message)) this._onresponse(message);
			else if (require_types$1.isJSONRPCRequest(message)) this._onrequest(message, extra);
			else if (require_types$1.isJSONRPCNotification(message)) this._onnotification(message);
	...
	_onclose() {
		...
		const error = require_types$1.McpError.fromError(require_types$1.ErrorCode.ConnectionClosed, "Connection closed");
	...
	_onrequest(request, extra) {
		...
		const relatedTaskId = request.params?._meta?.[require_types$1.RELATED_TASK_META_KEY]?.taskId;
		if (handler === void 0) {
			const errorResponse = {
				jsonrpc: "2.0",
				id: request.id,
				error: {
					code: require_types$1.ErrorCode.MethodNotFound,
		...
		const taskCreationParams = require_types$1.isTaskAugmentedRequestParams(request.params) ? request.params.task : void 0;
		...
		const fullExtra = {
			...
			sendRequest: async (r, resultSchema, options) => {
				if (abortController.signal.aborted) throw new require_types$1.McpError(require_types$1.ErrorCode.ConnectionClosed, "Request was cancelled");
		...
		Promise.resolve().then(() => {
			...
			const errorResponse = {
				...
				id: request.id,
				error: {
					code: Number.isSafeInteger(error["code"]) ? error["code"] : require_types$1.ErrorCode.InternalError,
	...
	_onresponse(response) {
		...
		if (resolver) {
			...
			if (require_types$1.isJSONRPCResultResponse(response)) resolver(response);
			else resolver(new require_types$1.McpError(response.error.code, response.error.message, response.error.data));
			return;
		}
		...
		if (require_types$1.isJSONRPCResultResponse(response) && response.result && typeof response.result === "object") {
		...
		if (require_types$1.isJSONRPCResultResponse(response)) handler(response);
		else handler(require_types$1.McpError.fromError(response.error.code, response.error.message, response.error.data));
	}
	get transport() {
	...
	async *requestStream(request, resultSchema, options) {
		...
		if (!task) {
			try {
				...
				yield {
					type: "error",
					error: error instanceof require_types$1.McpError ? error : new require_types$1.McpError(require_types$1.ErrorCode.InternalError, String(error))
				};
			}
			return;
		}
		let taskId;
		try {
			const createResult = await this.request(request, require_types$1.CreateTaskResultSchema, options);
			...
			} else throw new require_types$1.McpError(require_types$1.ErrorCode.InternalError, "Task creation did not return a task");
			while (true) {
				...
				if (isTerminal(task.status)) {
					if (task.status === "completed") yield {
						...
						type: "error",
						error: new require_types$1.McpError(require_types$1.ErrorCode.InternalError, `Task ${taskId} failed`)
					};
					else if (task.status === "cancelled") yield {
						type: "error",
						error: new require_types$1.McpError(require_types$1.ErrorCode.InternalError, `Task ${taskId} was cancelled`)
					};
					return;
				}
		...
		return new Promise((resolve, reject) => {
			...
			if (relatedTask) jsonrpcRequest.params = {
				...
				_meta: {
					...
					[require_types$1.RELATED_TASK_META_KEY]: relatedTask
				}
			};
			const cancel = (reason) => {
				this._responseHandlers.delete(messageId);
				...
				reject(reason instanceof require_types$1.McpError ? reason : new require_types$1.McpError(require_types$1.ErrorCode.RequestTimeout, String(reason)));
			};
			...
			const timeoutHandler = () => cancel(require_types$1.McpError.fromError(require_types$1.ErrorCode.RequestTimeout, "Request timed out", { timeout }));
	...
	*/
	async getTask(params, options) {
		return this.request({
			method: "tasks/get",
			params
		}, require_types$1.GetTaskResultSchema, options);
	}
	/**
	...
	*/
	async listTasks(params, options) {
		return this.request({
			method: "tasks/list",
			params
		}, require_types$1.ListTasksResultSchema, options);
	}
	/**
	...
	*/
	async cancelTask(params, options) {
		return this.request({
			method: "tasks/cancel",
			params
		}, require_types$1.CancelTaskResultSchema, options);
	}
	/**
			...
			const jsonrpcNotification = {
				...
				params: {
					...
					_meta: {
						...
						[require_types$1.RELATED_TASK_META_KEY]: options.relatedTask
					}
				}
			};
	...
	*/
	async _clearTaskQueue(taskId, sessionId) {
		if (this._taskMessageQueue) {
			...
			for (const message of messages) if (message.type === "request" && require_types$1.isJSONRPCRequest(message.message)) {
				const requestId = message.message.id;
				const resolver = this._requestResolvers.get(requestId);
				if (resolver) {
					resolver(new require_types$1.McpError(require_types$1.ErrorCode.InternalError, "Task cancelled or completed"));
					this._requestResolvers.delete(requestId);
	...
	*/
	async _waitForTaskUpdate(taskId, signal) {
		...
		return new Promise((resolve, reject) => {
			if (signal.aborted) {
				reject(new require_types$1.McpError(require_types$1.ErrorCode.InvalidRequest, "Request cancelled"));
				return;
			}
	...
	requestTaskStore(request, sessionId) {
		...
		return {
			...
			storeTaskResult: async (taskId, status, result) => {
				...
				const task = await taskStore.getTask(taskId, sessionId);
				if (task) {
					const notification = require_types$1.TaskStatusNotificationSchema.parse({
			...
			updateTaskStatus: async (taskId, status, statusMessage) => {
				const task = await taskStore.getTask(taskId, sessionId);
				if (!task) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Task "${taskId}" not found - it may have been cleaned up`);
				if (isTerminal(task.status)) throw new require_types$1.McpError(require_types$1.ErrorCode.InvalidParams, `Cannot update task "${taskId}" from terminal status "${task.status}" to "${status}". Terminal states (completed, failed, cancelled) cannot transition to other states.`);
...
var require_resolve = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var util_1 = require_util();
	var equal = require_json_schema_traverse$1.require_fast_deep_equal();
	var traverse = require_json_schema_traverse$1.require_json_schema_traverse();
...
var data_exports = /* @__PURE__ */ require_chunk.__exportAll({
	$id: () => $id$1,
...
var init_data = require_chunk.__esmMin((() => {
...
var require_scopedChars = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	module.exports = { HEX: {
		0: 0,
		1: 1,
		2: 2,
...
var require_core$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var dataType_1 = require_dataType();
	var util_1 = require_util();
	var $dataRefSchema = (init_data(), require_chunk.__toCommonJS(data_exports).default);
...
var require_validation = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_applicator = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var additionalItems_1 = require_additionalItems();
...
var json_schema_draft_07_exports = /* @__PURE__ */ require_chunk.__exportAll({
	$id: () => $id,
	$schema: () => $schema,
...
var init_json_schema_draft_07 = require_chunk.__esmMin((() => {
...
var require_ajv = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	...
	var draft7MetaSchema = (init_json_schema_draft_07(), require_chunk.__toCommonJS(json_schema_draft_07_exports).default);
...
Object.defineProperty(exports, "assertClientRequestTaskCapability", {
	enumerable: true,
	get: function() {
		return assertClientRequestTaskCapability;
	}
});
Object.defineProperty(exports, "assertToolsCallTaskCapability", {
	enumerable: true,
	get: function() {
		return assertToolsCallTaskCapability;
	}
});
Object.defineProperty(exports, "getLiteralValue", {
	enumerable: true,
	get: function() {
		return getLiteralValue;
	}
});
Object.defineProperty(exports, "getObjectShape", {
	enumerable: true,
	get: function() {
		return getObjectShape;
	}
});
Object.defineProperty(exports, "getParseErrorMessage", {
	enumerable: true,
	get: function() {
		return getParseErrorMessage;
	}
});
Object.defineProperty(exports, "getSchemaDescription", {
	enumerable: true,
	get: function() {
		return getSchemaDescription;
	}
});
Object.defineProperty(exports, "isSchemaOptional", {
	enumerable: true,
	get: function() {
		return isSchemaOptional;
	}
});
Object.defineProperty(exports, "isZ4Schema", {
	enumerable: true,
	get: function() {
		return isZ4Schema;
	}
...
Object.defineProperty(exports, "normalizeObjectSchema", {
	enumerable: true,
	get: function() {
		return normalizeObjectSchema;
	}
});
Object.defineProperty(exports, "objectFromShape", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "toJsonSchemaCompat", {
	enumerable: true,
	get: function() {

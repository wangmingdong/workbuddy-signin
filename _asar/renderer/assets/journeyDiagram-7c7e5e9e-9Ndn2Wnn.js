...
import { $ as arc_default, C as init_mermaid_59c9be08, Dt as require_dist, F as setAccTitle, J as init_src, L as setDiagramTitle, Ot as require_dayjs_min, P as setAccDescription, St as select_default, _ as getConfig, g as getAccTitle, h as getAccDescription, l as configureSvgSize, o as clear$1, y as getDiagramTitle } from "./mermaid-59c9be08-DUdjYWP7.js";
import { t as init_purify_es } from "./purify.es-CUVKlOTh.js";
import { a as drawText$1, c as init_svgDrawCommon_70a69047, i as drawRect$1, o as getNoteRect, t as drawBackgroundRect$1 } from "./svgDrawCommon-70a69047-knakP_I1.js";
//#region ../../node_modules/mermaid/dist/journeyDiagram-7c7e5e9e.js
...
var parser, parser$1, currentSection, sections, tasks, rawTasks, clear, addSection, getSections, getTasks, updateActors, addTask, addTaskOrg, compileTasks, getActors, db, getStyles, styles, drawRect, drawFace, drawCircle, drawText, drawLabel, drawSection, taskCount, drawTask, drawBackgroundRect, _drawTextCandidateFunc, initGraphics, svgDraw, setConf, actors, conf, LEFT_MARGIN, draw, bounds, fills, textColours, drawTasks, renderer, diagram;
//#endregion
__esmMin((() => {
...
`;
	...
	drawSection = function(elem, section, conf2) {
	...
	taskCount = -1;
	drawTask = function(elem, task, conf2) {
	...
	actors = {};
	conf = getConfig().journey;
	LEFT_MARGIN = conf.leftMargin;
	...
	fills = conf.sectionFills;
	textColours = conf.sectionColours;
	drawTasks = function(diagram2, tasks2, verticalPos) {
		const conf2 = getConfig().journey;
		let lastSection = "";

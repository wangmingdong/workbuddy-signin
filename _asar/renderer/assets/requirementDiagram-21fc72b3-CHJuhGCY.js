...
import { C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, F as setAccTitle, J as init_src, Ot as require_dayjs_min, P as setAccDescription, St as select_default, Z as line_default, _ as getConfig, g as getAccTitle, h as getAccDescription, l as configureSvgSize, o as clear$1, s as common$1 } from "./mermaid-59c9be08-DUdjYWP7.js";
...
`;
	...
	insertLineEndings = (parentNode, conf2) => {
	...
	newTitleNode = (parentNode, id, txts) => {
	...
	newBodyNode = (parentNode, id, txts, yStart) => {
	...
	addEdgeLabel = (parentNode, svgPath, conf2, txt) => {
	...
	drawElements = (els, graph, svgNode) => {

...
import { A as random, B as utils, C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, F as setAccTitle, J as init_src, L as setDiagramTitle, Ot as require_dayjs_min, P as setAccDescription, R as setupGraphViewbox, St as select_default, _ as getConfig, g as getAccTitle, h as getAccDescription, o as clear$2, s as common$1, y as getDiagramTitle } from "./mermaid-59c9be08-DUdjYWP7.js";
import { t as init_purify_es } from "./purify.es-CUVKlOTh.js";
//#region ../../node_modules/mermaid/dist/gitGraphDiagram-fc1f5991.js
function getId() {
...
var parser, gitGraphParser, mainBranchName, mainBranchOrder, commits, head, branchesConfig, branches, curBranch, direction, seq, setDirection, options, setOptions, getOptions, commit, branch, merge, cherryPick, checkout, prettyPrint, clear$1, getBranchesAsObjArray, getBranches, getCommits, getCommitsArray, getCurrentBranch, getDirection, getHead, commitType$1, gitGraphDb, allCommitsDict, commitType, THEME_COLOR_LIMIT, branchPos, commitPos, lanes, maxPos, dir, clear, drawText, findClosestParent, drawCommits, shouldRerouteArrow, findLane, drawArrow, drawArrows, drawBranches, draw, gitGraphRenderer, getStyles, diagram;
//#endregion
__esmMin((() => {
	...
	gitGraphParser = parser;
	mainBranchName = getConfig().gitGraph.mainBranchName;
	mainBranchOrder = getConfig().gitGraph.mainBranchOrder;
	commits = {};
	head = null;
	branchesConfig = {};
	...
	direction = "LR";
	seq = 0;
	setDirection = function(dir2) {
		direction = dir2;
	};
	options = {};
	setOptions = function(rawOptString) {
	...
	commit = function(msg, id, type, tag) {
	...
	merge = function(otherBranch, custom_id, override_type, custom_tag) {
	...
	cherryPick = function(sourceId, targetId, tag, parentCommitId) {
	...
	drawCommits = (svg, commits2, modifyGraph) => {
	...
	shouldRerouteArrow = (commitA, commitB, p1, p2, allCommits) => {
	...
	drawArrow = (svg, commitA, commitB, allCommits) => {
	...
	draw = function(txt, id, ver, diagObj) {
		clear();

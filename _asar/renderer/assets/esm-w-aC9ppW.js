import { n as __esmMin, r as __exportAll, s as __toESM, t as __commonJSMin } from "./chunk-BRZcfu7K.js";
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/typeof.js
function _typeof(o) {
...
//#endregion
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/classCallCheck.js
function _classCallCheck(a, n) {
	if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function");
}
var init_classCallCheck = __esmMin((() => {}));
//#endregion
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/toPrimitive.js
...
//#endregion
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/toPropertyKey.js
...
//#endregion
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/createClass.js
...
//#endregion
//#region ../../node_modules/@tencent/docs-config/node_modules/@babel/runtime/helpers/esm/defineProperty.js
...
//#endregion
//#region ../../node_modules/lodash.get/index.js
var require_lodash_get = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* lodash (Custom Build) <https://lodash.com/>
	* Build: `lodash modularize exports="npm" -o ./`
...
//#endregion
//#region ../../node_modules/lodash.isempty/index.js
var require_lodash_isempty = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* lodash (Custom Build) <https://lodash.com/>
	* Build: `lodash modularize exports="npm" -o ./`
	* Copyright jQuery Foundation and other contributors <https://jquery.org/>
	...
	*/
	...
	var reIsNative = RegExp("^" + funcToString.call(hasOwnProperty).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
	/** Built-in value references. */
	var Buffer = moduleExports ? root.Buffer : void 0, propertyIsEnumerable = objectProto.propertyIsEnumerable;
	var nativeIsBuffer = Buffer ? Buffer.isBuffer : void 0, nativeKeys = overArg(Object.keys, Object);
...
//#endregion
//#region ../../node_modules/@tencent/docs-config/dist/esm/utils.js
/**
* 从传入的 url 或者 location 中, 获取单个指定 key 的 查询结果;
* 返回 '' 空字符或者对应的值.
* @param key
* @param url
*/
function getURLQuery(key, url) {
	...
	var m = null;
	var search = (url ? "?".concat(url.split("?")[1] || "") : (_global$location = globalThis.location) === null || _global$location === void 0 ? void 0 : _global$location.search) || "";
	if (search) m = search.match(new RegExp("(\\?|&)".concat(key, "=([^&]*)(&|$)")));
	return !m ? "" : decodeURIComponent(m[2]);
}
var init_utils = __esmMin((() => {}));
//#endregion
//#region ../../node_modules/@tencent/docs-config/dist/esm/config-manager.js
var import_lodash_merge, import_lodash_get, import_lodash_isempty, import_lodash_clonedeep, ConfigCache, DocsConfig;
var init_config_manager = __esmMin((() => {
	init_typeof();
	init_classCallCheck();
	init_createClass();
	init_defineProperty();
	import_lodash_merge = /* @__PURE__ */ __toESM(require_lodash_merge());
	import_lodash_get = /* @__PURE__ */ __toESM(require_lodash_get());
	import_lodash_isempty = /* @__PURE__ */ __toESM(require_lodash_isempty());
	import_lodash_clonedeep = /* @__PURE__ */ __toESM(require_lodash_clonedeep());
	init_utils();
	ConfigCache = /* @__PURE__ */ function() {
		...
		_createClass(ConfigCache, [
			{
				...
				value: function bind(data) {
					(0, import_lodash_merge.default)(this.cache, data);
				}
			},
			{
				key: "get",
				value: function get(key) {
					return (0, import_lodash_get.default)(this.cache, key);
				}
			},
			{
				key: "clear",
	...
	DocsConfig = /* @__PURE__ */ function() {
		function DocsConfig() {
			_classCallCheck(this, DocsConfig);
			_defineProperty(this, "cache", void 0);
			this.cache = new ConfigCache();
			this.init();
		}
		_createClass(DocsConfig, [
			{
				key: "bind",
				value: function bind(data) {
					if (!(0, import_lodash_isempty.default)(data)) this.cache.bind(data);
			...
			},
			{
				...
				value: function getConfig(key) {
					...
					if (_typeof(value) === "object") return (0, import_lodash_clonedeep.default)(value);
					return value;
				}
			},
			{
				...
				value: function getAllConfig() {
					var _this$cache$getAll;
					return (0, import_lodash_clonedeep.default)((_this$cache$getAll = this.cache.getAll()) !== null && _this$cache$getAll !== void 0 ? _this$cache$getAll : {});
				}
			},
			{
				key: "saveToSessionStorage",
				value: function saveToSessionStorage(data) {
					try {
						if (typeof self !== "undefined" && self.sessionStorage) {
							var _ref;
							var configData = (_ref = data !== null && data !== void 0 ? data : this.cache.getAll()) !== null && _ref !== void 0 ? _ref : {};
							self.sessionStorage.setItem("configCache", JSON.stringify(configData));
							return true;
						}
					} catch (e) {
						console.error(e);
			...
			},
			{
				...
				value: function loadFromSessionStorage() {
					try {
						if (typeof self !== "undefined" && self.sessionStorage) {
							var configCache = self.sessionStorage.getItem("configCache");
							if (configCache) {
								this.bind(JSON.parse(configCache));
								return true;
							}
						} else throw new Error("browser is not support sessionStorage");
					} catch (e) {
						console.error(e);
					}
					return false;
			...
			},
			{
				...
				value: function init() {
					...
					var config = self.AppConfig;
					if (_typeof(config) !== "object") return;
					var mode = getURLQuery("mode");
					var json = (0, import_lodash_merge.default)(config._common || {}, config[mode] || config.normal || {});
					this.bind(json);
				}
			}
		], [{
			...
			value: function getInstance() {
				if (!this.instance) this.instance = new DocsConfig();
				return this.instance;
			}
		}]);
		return DocsConfig;
	}();
	_defineProperty(DocsConfig, "instance", void 0);
}));
//#endregion
//#region ../../node_modules/@tencent/docs-config/dist/esm/config-constants.js
var ConfigItem;
var init_config_constants = __esmMin((() => {
	init_classCallCheck();
	init_createClass();
	init_defineProperty();
	ConfigItem = /* @__PURE__ */ function() {
		function ConfigItem() {
			_classCallCheck(this, ConfigItem);
		}
		_createClass(ConfigItem, null, [{
			key: "getKey",
			value: function getKey(propName) {
				if (this.configName === "") throw new Error("子类未重命名configName!");
				return "".concat(this.configName, ".").concat(propName);
			}
		}]);
		return ConfigItem;
	}();
	_defineProperty(ConfigItem, "configName", "");
}));
//#endregion
//#region ../../node_modules/@tencent/docs-config/dist/esm/index.js
...
var init_esm = __esmMin((() => {
	...
	esm_default = DocsConfig;
}));
//#endregion
export { esm_exports as n, init_esm as r, esm_default as t };

...
import { B as utils, C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, F as setAccTitle, J as init_src, L as setDiagramTitle, Ot as require_dayjs_min, P as setAccDescription, St as select_default, Y as basis_default, Z as line_default, _ as getConfig, g as getAccTitle, h as getAccDescription, k as parseGenericTypes, l as configureSvgSize, o as clear$1, y as getDiagramTitle } from "./mermaid-59c9be08-DUdjYWP7.js";
...
//#region ../../node_modules/mermaid/node_modules/uuid/dist/regex.js
var regex_default;
var init_regex = __esmMin((() => {
	regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;
}));
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/validate.js
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/parse.js
function parse(uuid) {
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/stringify.js
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/v35.js
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/sha1.js
function f(s, x, y, z) {
	switch (s) {
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/v5.js
...
//#endregion
//#region ../../node_modules/mermaid/node_modules/uuid/dist/index.js
...
//#endregion
//#region ../../node_modules/mermaid/dist/erDiagram-0ae87a1d.js
...
var parser, erParser, entities, relationships, Cardinality, Identification, addEntity, getEntities, addAttributes, addRelationship, getRelationships, clear, erDb, ERMarkers, insertMarkers, erMarkers, BAD_ID_CHARS_REGEXP, conf, entityNameIds, setConf, drawAttributes, drawEntities, adjustEntities, getEdgeName, addRelationships, relCnt, drawRelationshipFromLayout, draw, MERMAID_ERDIAGRAM_UUID, erRenderer, getStyles, diagram;
//#endregion
__esmMin((() => {
	...
	addEntity = function(name, alias = void 0) {
	...
	addRelationship = function(entA, rolA, entB, rSpec) {
		let rel = {
			entityA: entA,
			roleA: rolA,
			entityB: entB,
	...
	insertMarkers = function(elem, conf2) {
		let marker;
	...
	drawAttributes = (groupNode, entityTextNode, attributes) => {
	...
	drawEntities = function(svgNode, entities2, graph) {
	...
	adjustEntities = function(svgNode, graph) {
	...
	getEdgeName = function(rel) {
		return (rel.entityA + rel.roleA + rel.entityB).replace(/\s/g, "");
	};
	addRelationships = function(relationships2, g) {
	...
	relCnt = 0;
	drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
		relCnt++;
	...
	draw = function(text, id, _version, diagObj) {
		conf = getConfig().er;

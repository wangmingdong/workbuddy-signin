...
//#region ../../packages/conversation-render/src/shared/icons/agent/logo-icon.tsx
var import_jsx_runtime, AgentLogoIcon;
//#endregion
__esmMin((() => {
	require_react();
	import_jsx_runtime = require_jsx_runtime();
	AgentLogoIcon = ({ className, style, ...rest }) => {
		const clipPathId = "cr-agent-logo-clip";
...
export { AgentLogoIcon as default };

...
import { G as clone, N as map, t as init_lodash, x as isUndefined } from "./lodash-D1c13HHR.js";
import { C as init_mermaid_59c9be08, E as log$1, J as init_src, St as select_default, _ as getConfig, p as evaluate } from "./mermaid-59c9be08-DUdjYWP7.js";
import { n as createText, r as init_createText_31840e8c } from "./createText-31840e8c-BTw4yiRB.js";
import { _ as updateNodeBounds, c as insertEdge, d as insertNode, f as intersectRect$1, g as setNodeElem, h as positionNode, i as createLabel$1, l as insertEdgeLabel, m as positionEdgeLabel, n as clear$2, o as getSubGraphTitleMargins, r as clear$1$1, s as init_edges_c9cd0ec5, u as insertMarkers$1 } from "./edges-c9cd0ec5-Bi7G02y5.js";
import { n as Graph, r as init_graph, t as init_graphlib } from "./graphlib-B3HAtIYg.js";
...
var clusterDb, descendants, parents, clear$1, isDescendant, edgeInCluster, copy, extractDescendants, findNonClusterChild, getAnchorId, adjustClustersAndEdges, extractor, sorter, sortNodesByHierarchy, rect, noteGroup, roundedWithTitle, divider, shapes, clusterElems, insertCluster, clear, recursiveRender, render;
var init_index_bf99f535 = __esmMin((() => {
	init_dagre();
	init_json();
	init_edges_c9cd0ec5();
	...
	adjustClustersAndEdges = (graph, depth) => {
		if (!graph || depth > 10) {
	...
	sortNodesByHierarchy = (graph) => sorter(graph, graph.children());
	rect = (parent, node) => {
	...
	recursiveRender = async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
	...
	render = async (elem, graph, markers, diagramType, id) => {
...
//#endregion
export { render as n, init_json as r, init_index_bf99f535 as t };

...
import { C as init_mermaid_59c9be08, Dt as require_dist, F as setAccTitle, J as init_src$4, L as setDiagramTitle, Ot as require_dayjs_min, P as setAccDescription, St as select_default, _ as getConfig, d as defaultConfig, et as Tableau10_default, g as getAccTitle, h as getAccDescription, o as clear$1, s as common$1, vt as ordinal, y as getDiagramTitle, z as setupGraphViewbox$1 } from "./mermaid-59c9be08-DUdjYWP7.js";
...
//#endregion
//#region ../../node_modules/d3-sankey/node_modules/d3-array/src/index.js
...
//#endregion
//#region ../../node_modules/d3-sankey/node_modules/d3-path/src/index.js
...
//#endregion
//#region ../../node_modules/d3-sankey/node_modules/d3-shape/src/index.js
...
var init_sankeyLinkHorizontal = __esmMin((() => {
	init_src$1();
}));
//#endregion
//#region ../../node_modules/d3-sankey/src/index.js
var init_src = __esmMin((() => {
	init_sankey();
	init_align();
	init_sankeyLinkHorizontal();
})), parser, parser$1, links, nodes, nodesMap, clear, SankeyLink, addLink, SankeyNode, findOrCreateNode, getNodes, getLinks, getGraph, db, _Uid, Uid, alignmentsMap, draw, renderer, prepareTextForParsing, originalParse, diagram;
//#endregion
__esmMin((() => {
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
	...
	renderer = { draw };
	prepareTextForParsing = (text) => {
		return text.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, "\n").trim();
	};
	originalParse = parser$1.parse.bind(parser$1);

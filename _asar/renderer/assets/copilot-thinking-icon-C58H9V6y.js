...
//#region ../../packages/conversation-render/src/shared/icons/agent/copilot-thinking-icon.tsx
var import_jsx_runtime, CopilotThinkingIcon;
//#endregion
__esmMin((() => {
	require_react();
	import_jsx_runtime = require_jsx_runtime();
	CopilotThinkingIcon = ({ className, style, id, ...rest }) => {
		const suffix = id || "default";
		const clipPathId = `cr-copilot-thinking-clip-${suffix}`;
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("g", {
						id: `leftEye${suffix}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("rect", {
							x: "12.2119",
							y: "17.2593",
							width: "2.13173",
							height: "4.42744",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
									...
									values: "4.42744;4.42744;2.2;2.2;4.42744;4.42744",
									dur: "0.3s",
									begin: `moveLeft${suffix}.end+0.5s`,
									id: `blinkLeft${suffix}`
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animateTransform", {
									...
									type: "translate",
									values: "0,0;0,0; -2,0;-2,0; -2,-2;-2,-2; 2,-2;2,-2; 2,0;2,0; 0,0; 0,0",
									dur: "6s",
									begin: `0s;blinkLeft${suffix}.end+2s`,
									id: `moveLeft${suffix}`,
									additive: "sum"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
									attributeName: "height",
									values: "4.42744;4.42744;4.42744;4.42744;2.2;2.2;2.2;2.2;4.42744;4.42744;4.42744;4.42744",
									dur: "6s",
									begin: `0s;blinkLeft${suffix}.end+2s`
								})
							]
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("rect", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
									...
									values: "4.42744;4.42744;2.2;2.2;4.42744;4.42744",
									dur: "0.3s",
									begin: `moveLeft2${suffix}.end+0.5s`,
									id: `blinkLeft2${suffix}`
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
									attributeName: "opacity",
									values: "1; 0.2; 1",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animateTransform", {
									...
									values: "0,0;0,0; -2,0;-2,0; -2,-2;-2,-2; 2,-2;2,-2; 2,0;2,0; 0,0; 0,0",
									dur: "6s",
									begin: `0s;blinkLeft2${suffix}.end+2s`,
									id: `moveLeft2${suffix}`,
									additive: "sum"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("animate", {
...
export { CopilotThinkingIcon as default };

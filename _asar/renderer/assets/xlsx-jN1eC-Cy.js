...
__esmMin((() => {
	...
	has_buf = /* @__PURE__ */ (function() {
		return typeof Buffer !== "undefined" && typeof process$1 !== "undefined" && typeof process$1.versions !== "undefined" && !!process$1.versions.node;
	})();
	...
	attregexg = /([^"\s?>\/]+)\s*=\s*((?:")([^"]*)(?:")|(?:')([^']*)(?:')|([^'">\s]+))/g;
	tagregex1 = /<[\/\?]?[a-zA-Z0-9:_-]+(?:\s+[^"\s?>\/]+\s*=\s*(?:"[^"]*"|'[^']*'|[^'">\s=]+))*\s*[\/\?]?>/gm;
	tagregex = /* @__PURE__ */ XML_HEADER.match(tagregex1) ? tagregex1 : /<[^>]*>/g;
	...
	XLSIcv = /* @__PURE__ */ dup(/* @__PURE__ */ rgbify([
		0,
		16777215,
		16711680,
		65280,
	...
	CORE_PROPS_REGEX = /* @__PURE__ */ (function() {
	...
	sitregex = /<(?:\w+:)?t[^>]*>([^<]*)<\/(?:\w+:)?t>/g, sirregex = /<(?:\w+:)?r>/;

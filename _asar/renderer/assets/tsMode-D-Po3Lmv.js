			...
			if (!this._client) this._client = (async () => {
				this._worker = createWebWorker({
					...
					createWorker: () => new Worker(new URL(
						/* @vite-ignore */
						"" + new URL("ts.worker-BenV9l5S.js", import.meta.url).href,
						"" + import.meta.url
					), { type: "module" }),
					label: this._modeId,
					keepIdleModels: true,
...
var init_languageFeatures = __esmMin((() => {
	...
	SuggestAdapter = class SuggestAdapter extends Adapter {
...
${tagToString(tag)}`;
	...
	SignatureHelpAdapter = class SignatureHelpAdapter extends Adapter {
		constructor() {
			super(...arguments);

...
var assign$1, utils, pica, image_traverse, jpeg_plugins, imageBlobReduce;
//#endregion
__esmMin((() => {
	assign$1 = function assign(to) {
		var from;
	...
	pica = createCommonjsModule(function(module, exports) {
		(function(f) {
			module.exports = f();
		})(function() {
			return (function() {
	...
	image_traverse = createCommonjsModule(function(module) {

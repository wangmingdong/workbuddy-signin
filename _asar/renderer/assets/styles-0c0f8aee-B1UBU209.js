...
import { C as init_mermaid_59c9be08, E as log$1, F as setAccTitle, L as setDiagramTitle, P as setAccDescription, _ as getConfig, g as getAccTitle, h as getAccDescription, m as generateId, o as clear$1, s as common$1, y as getDiagramTitle } from "./mermaid-59c9be08-DUdjYWP7.js";
...
var parser, parser$1, DEFAULT_DIAGRAM_DIRECTION, STMT_STATE, STMT_RELATION, STMT_CLASSDEF, STMT_APPLYCLASS, DEFAULT_STATE_TYPE, DIVIDER_TYPE, START_NODE, START_TYPE, END_NODE, END_TYPE, COLOR_KEYWORD, FILL_KEYWORD, BG_FILL, STYLECLASS_SEP, direction, rootDoc, classes, newDoc, documents, currentDocument, startEndCount, dividerCnt, lineType, relationType, clone, setRootDoc, getRootDoc, docTranslator, getRootDocV2, extract, addState, clear, getState, getStates, logDocuments, getRelations, addRelation, addDescription, cleanupLabel, getDividerId, addStyleClass, getClasses, setCssClass, setStyle, setTextStyle, getDirection, setDirection, trimColon, db, getStyles, styles;
var init_styles_0c0f8aee = __esmMin((() => {
	...
	addState = function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles2 = null, textStyles = null) {
	...
	addRelation = function(item1, item2, title) {
	...
	addDescription = function(id, descr) {
	...
	setStyle = function(itemId, styleText) {
		const item = getState(itemId);
		if (item !== void 0) item.textStyles.push(styleText);
	};
	setTextStyle = function(itemId, cssClassName) {
		const item = getState(itemId);
...
//#endregion
export { db as a, styles as c, STMT_STATE as i, DIVIDER_TYPE as n, init_styles_0c0f8aee as o, STMT_RELATION as r, parser$1 as s, DEFAULT_STATE_TYPE as t };

...
var conf, atoms, keywords, reserved, predeclared_enums, predeclared_types, predeclared_type_generators, predeclared_type_aliases, predeclared_intrinsics, operators, directive_re, ident_re, predefined_token, language;
//#endregion
__esmMin((() => {
	conf = {
		comments: {
...
`);
	operators = qw(`
					 ...
					 *=
					 ...
					 <<=
					 `);
	directive_re = /enable|requires|diagnostic/;
	ident_re = /[_\p{XID_Start}]\p{XID_Continue}*/u;
	predefined_token = "variable.predefined";
	language = {
		tokenPostfix: ".wgsl",

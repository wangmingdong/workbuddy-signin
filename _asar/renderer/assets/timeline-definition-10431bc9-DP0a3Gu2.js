...
import { $ as arc_default, C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, G as isDark, H as init_dist, J as init_src, Ot as require_dayjs_min, St as select_default, U as darken, W as lighten, _ as getConfig, c as commonDb, o as clear$1, z as setupGraphViewbox$1 } from "./mermaid-59c9be08-DUdjYWP7.js";
import { t as init_purify_es } from "./purify.es-CUVKlOTh.js";
//#region ../../node_modules/mermaid/dist/timeline-definition-10431bc9.js
...
var parser, parser$1, currentSection, currentTaskId, sections, tasks, rawTasks, getCommonDb, clear, addSection, getSections, getTasks, addTask, addEvent, addTaskOrg, compileTasks, db, MAX_SECTIONS, drawRect, drawFace, drawCircle, drawText, drawLabel, drawSection, taskCount, drawTask, drawBackgroundRect, getTextObj, getNoteRect, _drawTextCandidateFunc, initGraphics, drawNode, getVirtualNodeHeight, defaultBkg, svgDraw, draw, drawTasks, drawEvents, renderer, genSections, getStyles, diagram;
//#endregion
__esmMin((() => {
	...
	drawFace = function(element, faceData) {
		const radius = 15;
	...
	drawCircle = function(element, circleData) {
	...
	drawSection = function(elem, section, conf) {
	...
	taskCount = -1;
	drawTask = function(elem, task, conf) {
	...
	drawBackgroundRect = function(elem, bounds) {
		drawRect(elem, {
			x: bounds.startx,
			y: bounds.starty,
	...
	drawNode = function(elem, node, fullSection, conf) {
	...
	getVirtualNodeHeight = function(elem, node, conf) {
	...
	defaultBkg = function(elem, node, section) {
		const rd = 5;
	...
	drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
		var _a;
	...
	drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf) {

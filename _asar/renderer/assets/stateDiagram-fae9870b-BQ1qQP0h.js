...
import { B as utils, C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, J as init_src, Ot as require_dayjs_min, St as select_default, Y as basis_default, Z as line_default, _ as getConfig, l as configureSvgSize, s as common$1 } from "./mermaid-59c9be08-DUdjYWP7.js";
...
import { a as db, c as styles, o as init_styles_0c0f8aee, s as parser$1 } from "./styles-0c0f8aee-B1UBU209.js";
//#region ../../node_modules/mermaid/dist/stateDiagram-fae9870b.js
var idCache, set, get, keys, size, idCache$1, drawStartState, drawDivider, drawSimpleState, drawDescrState, addTitleAndBox, drawEndState, drawForkJoinState, _drawLongText, drawNote, drawState, edgeCount, drawEdge, conf, transformationLog, setConf, insertMarkers, draw, getLabelWidth, renderDoc, diagram;
//#endregion
__esmMin((() => {
	...
	drawStartState = (g) => g.append("circle").attr("class", "start-state").attr("r", getConfig().state.sizeUnit).attr("cx", getConfig().state.padding + getConfig().state.sizeUnit).attr("cy", getConfig().state.padding + getConfig().state.sizeUnit);
	drawDivider = (g) => g.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", getConfig().state.textHeight).attr("class", "divider").attr("x2", getConfig().state.textHeight * 2).attr("y1", 0).attr("y2", 0);
	...
	addTitleAndBox = (g, stateDef, altBkg) => {
	...
	drawState = function(elem, stateDef) {
	...
	edgeCount = 0;
	drawEdge = function(elem, path, relation) {
	...
	renderDoc = (doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {

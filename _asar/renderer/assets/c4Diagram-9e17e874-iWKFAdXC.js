...
import { C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, F as setAccTitle, J as init_src, M as sanitizeText$2, Ot as require_dayjs_min, P as setAccDescription, St as select_default, V as wrapLabel, _ as getConfig, g as getAccTitle, h as getAccDescription, i as calculateTextWidth, l as configureSvgSize, r as calculateTextHeight, s as common$1, t as assignWithDepth$1 } from "./mermaid-59c9be08-DUdjYWP7.js";
import { t as init_purify_es } from "./purify.es-CUVKlOTh.js";
import { c as init_svgDrawCommon_70a69047, i as drawRect$1, o as getNoteRect } from "./svgDrawCommon-70a69047-knakP_I1.js";
...
var import_dist, parser, parser$1, c4ShapeArray, boundaryParseStack, currentBoundaryParse, parentBoundaryParse, boundaries, rels, title, wrapEnabled, c4ShapeInRow$1, c4BoundaryInRow$1, c4Type, getC4Type, setC4Type, addRel, addPersonOrSystem, addContainer, addComponent, addPersonOrSystemBoundary, addContainerBoundary, addDeploymentNode, popBoundaryParseStack, updateElStyle, updateRelStyle, updateLayoutConfig, getC4ShapeInRow, getC4BoundaryInRow, getCurrentBoundaryParse, getParentBoundaryParse, getC4ShapeArray, getC4Shape, getC4ShapeKeys, getBoundaries, getBoundarys, getRels, getTitle, setWrap, autoWrap, clear, LINETYPE, ARROWTYPE, PLACEMENT, setTitle, db, drawRect, drawImage, drawRels$1, drawBoundary$1, drawC4Shape, insertDatabaseIcon, insertComputerIcon, insertClockIcon, insertArrowHead, insertArrowEnd, insertArrowFilledHead, insertDynamicNumber, insertArrowCrossHead, getC4ShapeFont, _drawTextCandidateFunc, svgDraw, globalBoundaryMaxX, globalBoundaryMaxY, c4ShapeInRow, c4BoundaryInRow, conf, Bounds, setConf, c4ShapeFont, boundaryFont, messageFont, drawBoundary, drawC4ShapeArray, Point, getIntersectPoint, getIntersectPoints, drawRels, draw, renderer, getStyles, diagram;
//#endregion
__esmMin((() => {
	...
	setC4Type = function(c4TypeParam) {
	...
	addComponent = function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
		if (alias === null || label === null) return;
		let component = {};
	...
	addContainerBoundary = function(alias, label, type, tags, link) {
		if (alias === null || label === null) return;
		let boundary = {};
		const old = boundaries.find((boundary2) => boundary2.alias === alias);
		if (old && alias === old.alias) boundary = old;
	...
	addDeploymentNode = function(nodeType, alias, label, type, descr, sprite, tags, link) {
		if (alias === null || label === null) return;
		let boundary = {};
		const old = boundaries.find((boundary2) => boundary2.alias === alias);
		if (old && alias === old.alias) boundary = old;
	...
	updateElStyle = function(typeC4Shape, elementName, bgColor, fontColor, borderColor, shadowing, shape, sprite, techn, legendText, legendSprite) {
	...
	updateRelStyle = function(typeC4Shape, from, to, textColor, lineColor, offsetX, offsetY) {
	...
	drawImage = function(elem, width, height, x, y, link) {
	...
	drawBoundary$1 = function(elem, boundary, conf2) {
	...
	drawC4Shape = function(elem, c4Shape, conf2) {
		var _a;
	...
	getC4ShapeFont = (cnf, typeC4Shape) => {
		return {
	...
	globalBoundaryMaxX = 0, globalBoundaryMaxY = 0;
	c4ShapeInRow = 4;
	c4BoundaryInRow = 2;
	parser.yy = db;
	conf = {};
	...
	drawBoundary = function(diagram2, boundary, bounds) {
	...
	drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
		let Y = 0;
	...
	getIntersectPoint = function(fromNode, endPoint) {
		let x1 = fromNode.x;
		let y1 = fromNode.y;
		let x2 = endPoint.x;
		let y2 = endPoint.y;
	...
	getIntersectPoints = function(fromNode, endNode) {
	...
	drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
		let i = 0;
		for (let rel of rels2) {
			i = i + 1;
	...
	draw = function(_text, id, _version, diagObj) {
		conf = getConfig().c4;

...
import { B as utils, C as init_mermaid_59c9be08, Dt as require_dist, E as log$1, F as setAccTitle, J as init_src, L as setDiagramTitle, M as sanitizeText$2, O as parseFontSize, Ot as require_dayjs_min, P as setAccDescription, S as hasKatex, St as select_default, _ as getConfig, g as getAccTitle, h as getAccDescription, j as renderKatexSanitized, l as configureSvgSize, n as calculateMathMLDimensions, o as clear$1, s as common$1, t as assignWithDepth$1, v as getConfig$1, y as getDiagramTitle } from "./mermaid-59c9be08-DUdjYWP7.js";
import { t as init_purify_es } from "./purify.es-CUVKlOTh.js";
import { c as init_svgDrawCommon_70a69047, i as drawRect$1, n as drawEmbeddedImage, o as getNoteRect$1, r as drawImage, s as getTextObj$1, t as drawBackgroundRect$1 } from "./svgDrawCommon-70a69047-knakP_I1.js";
...
var import_dist, parser, parser$1, ImperativeState, state, addBox, addActor, activationCount, addMessage, addSignal, hasAtLeastOneBox, hasAtLeastOneBoxWithTitle, getMessages, getBoxes, getActors, getCreatedActors, getDestroyedActors, getActor, getActorKeys, enableSequenceNumbers, disableSequenceNumbers, showSequenceNumbers, setWrap, autoWrap, clear, parseMessage, parseBoxData, LINETYPE, ARROWTYPE, PLACEMENT, addNote, addLinks, addALink, addProperties, addDetails, getActorProperty, apply, db, getStyles, styles, ACTOR_TYPE_WIDTH, TOP_ACTOR_CLASS, BOTTOM_ACTOR_CLASS, drawRect, drawPopup, popupMenuToggle, drawKatex, drawText, drawLabel, actorCnt, fixLifeLineHeights, drawActorTypeParticipant, drawActorTypeActor, drawActor, drawBox, anchorElement, drawActivation, drawLoop, drawBackgroundRect, insertDatabaseIcon, insertComputerIcon, insertClockIcon, insertArrowHead, insertArrowFilledHead, insertSequenceNumber, insertArrowCrossHead, getTextObj, getNoteRect, _drawTextCandidateFunc, _drawMenuItemTextCandidateFunc, svgDraw, conf, bounds, drawNote, messageFont, noteFont, actorFont, drawMessage, addActorRenderingData, drawActors, drawActorsPopup, setConf, actorActivations, activationBounds, draw, getRequiredPopupWidth, buildNoteModel, buildMessageModel, calculateLoopBounds, diagram;
//#endregion
__esmMin((() => {
	init_mermaid_59c9be08();
	init_src();
	import_dist = require_dist();
	init_svgDrawCommon_70a69047();
	require_dayjs_min();
	init_purify_es();
	parser = function() {
	...
	addActor = function(id, name, description, type) {
	...
	addSignal = function(idFrom, idTo, message = {
		text: void 0,
		wrap: void 0
	...
	showSequenceNumbers = () => state.records.sequenceNumbersEnabled;
	...
	getActorProperty = function(actor, key) {
...
`;
	...
	drawRect = function(elem, rectData) {
		return drawRect$1(elem, rectData);
	};
	drawPopup = function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
	...
	drawText = function(elem, textData) {
	...
	drawLabel = function(elem, txtObject) {
	...
	actorCnt = -1;
	fixLifeLineHeights = (diagram2, actors, actorKeys, conf2) => {
	...
	drawActorTypeParticipant = async function(elem, actor, conf2, isFooter) {
	...
	drawActorTypeActor = async function(elem, actor, conf2, isFooter) {
		const actorY = isFooter ? actor.stopy : actor.starty;
		const center = actor.x + actor.width / 2;
	...
	drawActor = async function(elem, actor, conf2, isFooter) {
		switch (actor.type) {
	...
	drawBox = async function(elem, box, conf2) {
		const g = elem.append("g");
	...
	drawActivation = function(elem, bounds2, verticalPos, conf2, actorActivations2) {
		const rect = getNoteRect$1();
	...
	drawLoop = async function(elem, loopModel, labelText, conf2) {
	...
	drawBackgroundRect = function(elem, bounds2) {
		drawBackgroundRect$1(elem, bounds2);
	};
	insertDatabaseIcon = function(elem) {
	...
	insertComputerIcon = function(elem) {
	...
	insertArrowFilledHead = function(elem) {
	...
	insertSequenceNumber = function(elem) {
	...
	_drawTextCandidateFunc = function() {
	...
	_drawMenuItemTextCandidateFunc = function() {
		function byText(content, g, x, y, width, height, textAttrs) {
	...
	drawNote = async function(elem, noteModel) {
	...
	drawMessage = async function(diagram2, msgModel, lineStartY, diagObj) {
	...
	addActorRenderingData = async function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
		let prevWidth = 0;
		let prevMargin = 0;
		let prevBox = void 0;
		let maxHeight = 0;
	...
	drawActors = async function(diagram2, actors, actorKeys, isFooter) {
	...
	drawActorsPopup = function(diagram2, actors, actorKeys, doc) {
		let maxHeight = 0;
		let maxWidth = 0;
		for (const actorKey of actorKeys) {
			const actor = actors[actorKey];
	...
	actorActivations = function(actor) {
		return bounds.activations.filter(function(activation) {
			return activation.actor === actor;
		});
	};
	activationBounds = function(actor, actors) {
	...
	draw = async function(_text, id, _version, diagObj) {
	...
	getRequiredPopupWidth = function(actor) {
	...
	buildNoteModel = async function(msg, actors, diagObj) {
	...
	buildMessageModel = function(msg, actors, diagObj) {
		if (![
			diagObj.db.LINETYPE.SOLID_OPEN,
			diagObj.db.LINETYPE.DOTTED_OPEN,
			diagObj.db.LINETYPE.SOLID,
	...
	calculateLoopBounds = async function(messages, actors, _maxWidthPerActor, diagObj) {
		const loops = {};
		const stack = [];

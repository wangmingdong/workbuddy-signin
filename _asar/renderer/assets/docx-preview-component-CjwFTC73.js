...
//#endregion
//#region ../../packages/context-viewer-components/src/media-preview/components/docx-preview/index.module.scss
var previewContainer, docxPreviewInstance, docxScrollWrapper, loadingContainer, errorContainer, index_module_default;
var init_index_module = __esmMin((() => {
	previewContainer = "_previewContainer_1g7vc_1";
	docxPreviewInstance = "_docxPreviewInstance_1g7vc_10";
	docxScrollWrapper = "_docxScrollWrapper_1g7vc_16";
	loadingContainer = "_loadingContainer_1g7vc_26";
	errorContainer = "_errorContainer_1g7vc_27";
...
//#endregion
//#region ../../packages/context-viewer-components/src/media-preview/components/docx-preview/docx-preview-component.tsx
var import_classnames, import_react, import_jsx_runtime, DOCX_BASE_WIDTH, DOCUMENT_OPTION, DocxPreviewComponent;
var init_docx_preview_component = __esmMin((() => {
	...
	DocxPreviewComponent = ({ className, filename, file }) => {
		const t = useTranslation();
		const docxRef = (0, import_react.useRef)(null);
		const [isLoading, setIsLoading] = (0, import_react.useState)(false);
		const scrollWrapperRef = (0, import_react.useRef)(null);
		(0, import_react.useEffect)(() => {
			if (file && docxRef.current) {
				setIsLoading(true);
				const dom = docxRef.current;
				requestAnimationFrame(() => {
					renderAsync(file, dom, void 0, DOCUMENT_OPTION).finally(() => {
						setIsLoading(false);
					});
				});
			}
		...
		(0, import_react.useEffect)(() => {
			...
			const docxInstance = docxRef.current;
			if (!scrollWrapper || !docxInstance) return;
			const updateZoom = () => {
				const containerWidth = scrollWrapper.clientWidth;
				if (containerWidth < DOCX_BASE_WIDTH) {
					const zoom = containerWidth / DOCX_BASE_WIDTH;
					docxInstance.style.zoom = String(zoom);
				} else docxInstance.style.zoom = "";
			};
			updateZoom();
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: media_module_default.disclaimerBanner,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("mediaPreview.disclaimer") })
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: index_module_default.docxScrollWrapper,
				ref: scrollWrapperRef,
				children: [isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: index_module_default.loadingContainer,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("mediaPreview.loading", { name: filename || "docx" }) })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					ref: docxRef,
					className: index_module_default.docxPreviewInstance
				})]
			})]
		});
	};
...
export { DocxPreviewComponent, init_docx_preview_component as t };

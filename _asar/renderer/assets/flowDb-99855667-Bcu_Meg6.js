...
var init_flowDb_99855667 = __esmMin((() => {
	...
	firstGraphFlag = true;
	funs = [];
	sanitizeText = (txt) => common$1.sanitizeText(txt, config);
	...
	addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
		let txt;
		let id = _id;
		if (id === void 0) return;
	...
	addSingleLink = function(_start, _end, type) {
		const edge = {
			start: _start,
			end: _end,
			type: void 0,
...
You have to call mermaid.initialize.`);
	...
	addLink = function(_start, _end, type) {
	...
	addSubGraph = function(_id, list, _title) {
...
//#endregion
export { parser$1 as i, flowDb as n, init_flowDb_99855667 as r, db as t };
